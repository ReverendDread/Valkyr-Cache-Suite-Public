...
public class Persistable implements Serializable {
	...
	public String xteaFile;
	public boolean focusOnSearch;
	public boolean notifications;
	public int revision;
	private ConfigBuilder builder = new ConfigBuilder("settings");
	...
	public void save() {
		...
		builder.add("xtea-file", xteaFile == null || xteaFile.isEmpty() ? "" : xteaFile);
	...
	public void delete() {
		FileUtilities.delete("settings.json");
	}
	...
	class SaveLoader extends JsonLoader {
		...
		public void load(JsonObject reader, Gson builder) {
			...
			if(reader.has("xtea-file"))
				persistable.xteaFile = reader.get("xtea-file").getAsString();
		}
		...
		public String filePath() {
			return Constants.DEFAULT_SAVE_DIR + File.separator + "settings.json";
		}
