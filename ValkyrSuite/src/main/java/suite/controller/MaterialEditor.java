...
public class MaterialEditor {
	...
	@FXML
	private ListView<MaterialRaw> mat_list;
	@FXML
	private TextField search_bar;
	private MaterialRaw material;

	@FXML
	private TextField aByte534, aByte533, effectId, effectParam1, color, speedU, speedV, aByte537, anInt519,
			effectParam2, blending;
	@FXML
	private CheckBox isDetailMaterial, aBoolean518, aBoolean538, aBoolean527, aBoolean544, aBoolean540, aBoolean541,
			aBoolean543;
