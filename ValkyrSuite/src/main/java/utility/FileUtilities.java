...
public class FileUtilities {
	...
	public static final Object load(String file_name) {
		...
		try {
			ObjectInputStream in = new ObjectInputStream(
					new FileInputStream(Constants.DEFAULT_SAVE_DIR + File.separator + file_name));
	 ...
	 * 
	 * @param object the {@code Serializable} object to save.
	...
	/**
	 * Strips extension off of file name.
	 * @param fileName
	 * @return
	 */
