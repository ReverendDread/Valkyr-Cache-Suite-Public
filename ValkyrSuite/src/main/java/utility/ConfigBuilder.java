 ...
 * 
 * @author ReverendDread Mar 25, 2019
 */
public class ConfigBuilder {
	 ...
	 * 
	 * @param type the class type creating the config.
	 */
	...
	public static final ConfigBuilder create(Class<?> type) {
		return new ConfigBuilder(type.getSimpleName());
	}
	 ...
	 * @param value    the value as a {@code JsonElement} value.
	 * @return
	 */
	 ...
	 * 
	 * @param property the property name.
	 * @param value    the value as a {@code Number} value.
	 * @return
	 */
	 ...
	 * 
	 * @param property the property name.
	 * @param value    the value as a {@code String} value.
	 * @return
	 */
	 ...
	 * 
	 * @param property the property name.
	 * @param value    the value as a {@code Boolean} value.
	 * @return
	 */
	...
	public final boolean save() {
		Path path = Paths.get(Constants.DEFAULT_SAVE_DIR, name + ".json");
