...
public class JagexColorPalette {
    ...
    public JagexColorPalette(double brightness, int var2, int var3) {
    ...
    public static int packHsl(int var0, int var1, int var2)
    {
        if (var2 > 179)
        {
            var1 /= 2;
    ...
    public static int getJagexColorIndex(int var0, int var1)
    {
        if (var0 == -1)
        {
            return 12345678;
